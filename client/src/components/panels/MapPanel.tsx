...
const QUICK_ZOOM_PRESETS = [
  ...
  { label: "Tacloban", name: "Tacloban", lat: 11.2543, lon: 124.9600, zoom: 12 },
  { label: "Bicol", name: "Bicol", lat: 13.1391, lon: 123.7438, zoom: 9 },
  { label: "Cagayan", name: "Cagayan Valley", lat: 17.6132, lon: 121.7270, zoom: 8.5 },
  { label: "Zamboanga", name: "Zamboanga", lat: 6.9214, lon: 122.0790, zoom: 11 },
];
          ...
          <div className={`mb-1 rounded-lg backdrop-blur-md shadow-xl border overflow-hidden w-52 ${
            ...
            <div className="py-1 max-h-[60vh] overflow-y-auto">
              {[
                ...
                { key: 'flood', label: 'Flood Risk Zones', active: showFlood, toggle: toggleFlood, color: '#41B6E6', loading: hazardLoading.flood, icon: <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2.69l5.66 5.66a8 8 0 1 1-11.31 0z"/></svg> },
                { key: 'landslide', label: 'Landslide Risk Zones', active: showLandslide, toggle: toggleLandslide, color: '#F2994A', loading: hazardLoading.landslide, icon: <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m8 3 4 8 5-5 5 15H2L8 3z"/></svg> },
                { key: 'surge', label: 'Storm Surge Risk Zones', active: showStormSurge, toggle: toggleStormSurge, color: '#B482FF', loading: hazardLoading.stormsurge, icon: <svg className="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 6c.6.5 1.2 1 2.5 1C7 7 7 5 9.5 5c2.6 0 2.4 2 5 2 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1"/><path d="M2 12c.6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 2.6 0 2.4 2 5 2 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1"/><path d="M2 18c.6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 2.6 0 2.4 2 5 2 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1"/></svg> },
